...
let div_cards = document.querySelector('div')
let obj_products = document.getElementsByClassName('products')[0]
...
function showCategory(category) {
    let selected_items = products[category]
    getProductMarkup(selected_items)
